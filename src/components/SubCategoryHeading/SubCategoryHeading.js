...
import SubCategoryHeadingTable from "./SubCategoryHeadingTable";
import { useCreateSubCategoryHeadingMutation } from "../../features/subCategoryHeading/subCategoryHeading";
...
function SubCategoryHeading() {
  ...
  const [createSubCategoryHeading] = useCreateSubCategoryHeadingMutation();
  ...
  const onFormSubmit = async (formData) => {
    ...
    try {
      const res = await createSubCategoryHeading(data);
      if (res.data?.success) {
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div>
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal}>
              <ModalHeader>Sub Category Heading</ModalHeader>
              <ModalBody>
